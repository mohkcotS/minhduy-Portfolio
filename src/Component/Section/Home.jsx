...
export const Home = () => {
    ...
    <div className="text-center z-10 px-4">
        ...
        <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">I'm a university student passionate about programming. I'm learning frontend and backend 
            to become a Full Stack Developer, always seeking opportunities to learn, practice, and work on real projects.</p>
